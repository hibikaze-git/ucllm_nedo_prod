...
python separete_domain_slimpajama.py slimpajama_dir output_dir
"""
...
def main(args):
    pattern = os.path.join(args.input_dir, "**/*.jsonl.zst")
    ...
    for file_path in tqdm(target_file_paths):
        ...
        for data in dataset:
            ...
            if set_name in separated_domain_list:
        ...
        for set_name, items in domains.items():
            ...
            output_path = os.path.join(args.output_dir, set_name, output_filename)
...
if __name__ == "__main__":
    ...
    for separated_domain in separated_domain_list:
        make_dir(os.path.join(args.output_dir, separated_domain))
