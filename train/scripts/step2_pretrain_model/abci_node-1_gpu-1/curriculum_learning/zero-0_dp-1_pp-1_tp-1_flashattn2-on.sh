...
train_tokens_in_billion=1 # int 0.4 → 1
...
data_path="/home/ucllm_nedo_prod/train/scripts/step1_train_tokenizer/document/wiki_65k_vocab_text_document"
...
template_json="${ucllm_nedo_prod_train_dir}/scripts/step2_pretrain_model/abci_node-1_gpu-1/curriculum_learning/ds_config_gpt_slw_TEMPLATE.json"
