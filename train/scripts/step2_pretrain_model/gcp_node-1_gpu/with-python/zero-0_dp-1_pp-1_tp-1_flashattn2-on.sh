...
data_path="/persistentshare/storage/team_nakamura/member/yamaguchi/ext_hrk_ymgch_gmail_com/ucllm_nedo_prod/train/scripts/step1_train_tokenizer/document/wiki_65k_1000000_with_python/wiki_65k_1000000_with_python_text_document"
